    ...
    if (videos && videos.length > 0 && videos[0]) {
      const urlElement = videos[0].url;
       ...
       let infoMess = {
         ...
         caption : `*MADARA-MD SONG DOWNLOADER*\n\n*Title:* ${videos[0].title}
...
france({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `*MADARA-MD VIDEO DOWNLOADER*\n\n*Title :* ${Element.title}
...
*Powered by ©BRYANT TECH*\n\n`
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*MADARA-MD*", gifPlayback: false }, { quoted: ms });
      });
